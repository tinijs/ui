...
export class AppPageGetStarted extends TiniComponent {
  protected render() {
    return html`
      ...
      <p>
        <strong>Quick note</strong>: A <code>THEME</code> is a combination of a
      ...
      <p>
        ...
        helps you to create new TiniJS projects quickly and manage themes easily
        by providing the <code>tini ui use</code> command.
      </p>
      <p>
        Github repo:
        <a href="https://github.com/tinijs/cli" target="_blank"
      ...
      <p>
        Pre-built packages are available on NPM. You can install them directly
        to your project.
      </p>
      <app-code
        language="bash"
...
npm i @tinijs/ui-bootstrap"
      ></app-code>
      <p>Include skins (and skin utils) in a global CSS file, for example:</p>
      <app-code
...
@import '../node_modules/@tinijs/ui-bootstrap/skin-utils.css';"
      ...
      <h3>Bootstrap</h3>
      <app-code language="bash" code="npm i @tinijs/ui-bootstrap"></app-code>
      <p>Official skins:</p>
      <ul>
