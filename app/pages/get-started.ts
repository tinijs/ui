  ...
  protected render() {
    return html`
      ...
      <ol>
        <li>
          Use the
          <a href="https://github.com/tinijs/cli" target="_blank" rel="noopener"
            >@tinijs/cli</a
          >
        ...
        <div slot="content">
          ...
          <ul>
            <li>
              <strong>Vue</strong>:
              <a
                href="https://github.com/tinijs/ui/tree/main/consumers/vue"
                target="_blank"
                rel="noopener"
                >https://github.com/tinijs/ui/tree/main/consumers/vue</a
              >
            </li>
            <li>
              <strong>Angular</strong>:
              <a
                href="https://github.com/tinijs/ui/tree/main/consumers/angular"
                target="_blank"
                rel="noopener"
                >https://github.com/tinijs/ui/tree/main/consumers/angular</a
              >
            </li>
            <li>
              <strong>React</strong>:
              <a
                href="https://github.com/tinijs/ui/tree/main/consumers/react"
                target="_blank"
                rel="noopener"
                >https://github.com/tinijs/ui/tree/main/consumers/react</a
              >
            </li>
            <li>
              <strong>Svelte</strong>:
              <a
                href="https://github.com/tinijs/ui/tree/main/consumers/svelte"
                target="_blank"
                rel="noopener"
                >https://github.com/tinijs/ui/tree/main/consumers/svelte</a
              >
            </li>
            <li>
              <strong>Tauri (no framework)</strong>:
              <a
                href="https://github.com/tinijs/ui/tree/main/consumers/tauri"
                target="_blank"
                rel="noopener"
                >https://github.com/tinijs/ui/tree/main/consumers/tauri</a
              >
            </li>
          </ul>
        </div>
