function i(i,t,s,e){Object.defineProperty(i,t,{get:s,set:e,enumerable:!0,configurable:!0})}var t=("undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{}).parcelRequire2169;t.register("1jLoc",function(s,e){i(s.exports,"AppPageComponentsIcon",function(){return d});var o=t("l73V3"),n=t("5B3HT"),c=t("aPFYP"),a=t("h2Kbd"),r=t("bt64Z"),M=t("8L1cM"),L=t("3o4bj");let d=class extends n.TiniComponent{render(){return(0,n.html)`
      <app-component-page
        titleText="Icons"
        name="icon"
    ...
    `}constructor(...i){super(...i),this.PART_LIST=[["icon","The root part"]],this.PREPROCESS_CODE=i=>i.replace(/\<tini\-icon/g,'<tini-icon src="URI/URL"')}};d=(0,o.__decorate)([(0,n.Page)({name:"app-page-components-icon",components:[c.TiniIconComponent,r.AppComponentPageComponent,M.AppSectionComponent,L.AppIconPageContentComponent],theming:{styling:(0,n.stylingWithBases)([c.commonBases,c.headingsBases,c.linkBases,c.textBases,c.codeBases])}})],d)}),t.register("h2Kbd",function(t,s){i(t.exports,"dataURI",function(){return o});let e="";atob(e);let o="data:image/svg+xml;base64,"+e}),t.register("8L1cM",function(s,e){i(s.exports,"AppSectionComponent",function(){return N});var o=t("l73V3"),n=t("5B3HT"),c=t("aPFYP"),a=t("i1M1E"),r=t("ZHozn"),M=t("ed9Am"),L=t("fWxFe"),d=t("90HH7"),l=t("iDR9r");let N=class extends n.TiniComponent{static #i=(()=>{this.defaultTagName="app-section"})();onCreate(){let i=this.querySelector('[slot="code"]')?.innerHTML.split("\n").map(i=>i.trimEnd()).filter(i=>!!i).join("\n");if(i){let[t]=i.split("<");i=i.split("\n").map(i=>i.replace(t,"").replace(/<!--\?lit\$([\s\S]*?)\$-->/g,"").replace(/(<!---->){2}/g,"\n").replace(/<!---->/g,"").replace(/<!-- \/ -->/g,"").replace(/<!--/g,"\n<!--")).join("\n"),this.originalCode=this.preprocessCode?this.preprocessCode(i,this.codeBuildContext):i}}render(){return(0,n.html)`
      <section>
...
//# sourceMappingURL=icon.687706b3.js.map
