!function(){function i(i,t,s,e){Object.defineProperty(i,t,{get:s,set:e,enumerable:!0,configurable:!0})}var t=("undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{}).parcelRequire2169;t.register("gf84y",function(s,e){i(s.exports,"AppPageComponentsIcon",function(){return d});var o=t("4tSb9"),n=t("1mUAS"),c=t("j09cH"),a=t("jsXUJ"),r=t("jLKyn"),M=t("h2glW"),L=t("6UxWj");let d=class extends n.TiniComponent{render(){return(0,n.html)`
      <app-component-page
        titleText="Icons"
        name="icon"
    ...
    `}constructor(...i){super(...i),this.PART_LIST=[["icon","The root part"]],this.PREPROCESS_CODE=i=>i.replace(/\<tini\-icon/g,'<tini-icon src="URI/URL"')}};d=(0,o.__decorate)([(0,n.Page)({name:"app-page-components-icon",components:[c.TiniIconComponent,r.AppComponentPageComponent,M.AppSectionComponent,L.AppIconPageContentComponent],theming:{styling:(0,n.stylingWithBases)([c.commonBases,c.headingsBases,c.linkBases,c.textBases,c.codeBases])}})],d)}),t.register("jsXUJ",function(t,s){i(t.exports,"dataURI",function(){return o});let e="";atob(e);let o="data:image/svg+xml;base64,"+e}),t.register("h2glW",function(s,e){i(s.exports,"AppSectionComponent",function(){return N});var o=t("4tSb9"),n=t("1mUAS"),c=t("j09cH"),a=t("8108p"),r=t("5kxRk"),M=t("5hSsq"),L=t("laxZI"),d=t("2de06"),l=t("10mzZ");let N=class extends n.TiniComponent{static #i=(()=>{this.defaultTagName="app-section"})();onCreate(){let i=this.querySelector('[slot="code"]')?.innerHTML.split("\n").map(i=>i.trimEnd()).filter(i=>!!i).join("\n");if(i){let[t]=i.split("<");i=i.split("\n").map(i=>i.replace(t,"").replace(/<!--\?lit\$([\s\S]*?)\$-->/g,"").replace(/(<!---->){2}/g,"\n").replace(/<!---->/g,"").replace(/<!-- \/ -->/g,"").replace(/<!--/g,"\n<!--")).join("\n"),this.originalCode=this.preprocessCode?this.preprocessCode(i,this.codeBuildContext):i}}render(){return(0,n.html)`
      <section>
    ...
    `}static #t=(()=>{this.styles=(0,n.css)`app-section [slot=content] h2{text-transform:capitalize}app-section [slot=code]{display:flex;flex-flow:column;gap:var(--size-space)}app-section [slot=code] tini-box{width:65px}.sizes [slot=code]{display:block}`})();constructor(...i){super(...i),this.noVariants=!1}};(0,o.__decorate)([(0,n.Input)({type:String})],a.prototype,"src",void 0),(0,o.__decorate)([(0,n.Input)({type:Boolean})],a.prototype,"noVariants",void 0),(0,o.__decorate)([(0,n.Input)({type:Object})],a.prototype,"preprocessCode",void 0),(0,o.__decorate)([(0,n.Input)({type:Object})],a.prototype,"codeBuildContext",void 0),a=(0,o.__decorate)([(0,n.Component)({components:[c.TiniBoxComponent,c.TiniIconComponent],theming:{styling:(0,n.stylingWithBases)([c.commonBases,c.headingsBases,c.linkBases,c.textBases,c.codeBases])}})],a)})}();
//# sourceMappingURL=icon.187c4fb3.js.map
