!function(){function i(i,t,s,e){Object.defineProperty(i,t,{get:s,set:e,enumerable:!0,configurable:!0})}var t=("undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{}).parcelRequire2169;t.register("j00uN",function(s,e){i(s.exports,"AppPageIconsIonic",function(){return r});var o=t("4tSb9"),n=t("1mUAS"),c=t("j09cH"),a=t("9w9kA");let r=class extends n.TiniComponent{render(){return(0,n.html)`
      <app-icon-page
      ...
      ></app-icon-page>
    `}};r=(0,o.__decorate)([(0,n.Page)({name:"app-page-icons-ionic",components:[a.AppIconPageComponent],theming:{styling:(0,n.stylingWithBases)([c.commonBases,c.headingsBases,c.linkBases,c.textBases])}})],r)}),t.register("h2glW",function(s,e){i(s.exports,"AppSectionComponent",function(){return u});var o=t("4tSb9"),n=t("1mUAS"),c=t("j09cH"),a=t("8108p"),r=t("5kxRk"),M=t("5hSsq"),L=t("laxZI"),d=t("2de06"),l=t("10mzZ");let u=class extends n.TiniComponent{static #i=(()=>{this.defaultTagName="app-section"})();onCreate(){let i=this.querySelector('[slot="code"]')?.innerHTML.split("\n").map(i=>i.trimEnd()).filter(i=>!!i).join("\n");if(i){let[t]=i.split("<");i=i.split("\n").map(i=>i.replace(t,"").replace(/<!--\?lit\$([\s\S]*?)\$-->/g,"").replace(/(<!---->){2}/g,"\n").replace(/<!---->/g,"").replace(/<!-- \/ -->/g,"").replace(/<!--/g,"\n<!--")).join("\n"),this.originalCode=this.preprocessCode?this.preprocessCode(i,this.codeBuildContext):i}}render(){return(0,n.html)`
      <section>
...
//# sourceMappingURL=ionic.f66d1060.js.map
