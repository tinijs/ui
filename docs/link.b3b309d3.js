!function(){function i(i,t,e,s){Object.defineProperty(i,t,{get:e,set:s,enumerable:!0,configurable:!0})}var t=("undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{}).parcelRequire2169;t.register("gjSoO",function(e,s){i(e.exports,"AppPageComponentsLink",function(){return c});var n=t("4tSb9"),o=t("1mUAS"),a=t("j09cH"),M=t("jLKyn"),r=t("h2glW");let c=class extends o.TiniComponent{render(){return(0,o.html)`
      <app-component-page
        titleText="Links"
        name="link"
    ...
    `}static #i=(()=>{this.styles=(0,o.css)`app-section [slot=content] h2{text-transform:capitalize}app-section [slot=code]{display:flex;flex-flow:column;gap:var(--size-space-0_5x)}app-section [slot=code] tini-box{width:375px}.sizes [slot=code]{display:block}`})();constructor(...i){super(...i),this.PART_LIST=[["link","The root part"]]}};c=(0,n.__decorate)([(0,o.Page)({name:"app-page-components-link",components:[a.TiniBoxComponent,a.TiniLinkComponent,M.AppComponentPageComponent,r.AppSectionComponent],theming:{styling:(0,o.stylingWithBases)([a.commonBases,a.headingsBases,a.linkBases,a.textBases,a.codeBases])}})],c)}),t.register("h2glW",function(e,s){i(e.exports,"AppSectionComponent",function(){return N});var n=t("4tSb9"),o=t("1mUAS"),a=t("j09cH"),M=t("8108p"),r=t("5kxRk"),c=t("5hSsq"),l=t("laxZI"),L=t("2de06"),d=t("10mzZ");let N=class extends o.TiniComponent{static #i=(()=>{this.defaultTagName="app-section"})();onCreate(){let i=this.querySelector('[slot="code"]')?.innerHTML.split("\n").map(i=>i.trimEnd()).filter(i=>!!i).join("\n");if(i){let[t]=i.split("<");i=i.split("\n").map(i=>i.replace(t,"").replace(/<!--\?lit\$([\s\S]*?)\$-->/g,"").replace(/(<!---->){2}/g,"\n").replace(/<!---->/g,"").replace(/<!-- \/ -->/g,"").replace(/<!--/g,"\n<!--")).join("\n"),this.originalCode=this.preprocessCode?this.preprocessCode(i,this.codeBuildContext):i}}render(){return(0,o.html)`
      <section>
...
//# sourceMappingURL=link.b3b309d3.js.map
