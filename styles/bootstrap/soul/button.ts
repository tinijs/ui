...
export const buttonStyle = css`
  :host {
    ...
    /* [MINOR] Dimmer or brighter to indicate the click action */
    --button-focus-visible-shadow-size: calc(var(--size-md) * 0.25)
      /* [MINOR] Size of the shadow while focusing */;
  ...
  .${unsafeCSS(Sizes.XS)} {
    ...
    --button-focus-visible-shadow-size: calc(var(--size-xs) * 0.5);
  }

  .${unsafeCSS(Sizes.SM)} {
    --button-font-size: calc(var(--size-sm) * 1.5);
    --button-padding: var(--size-sm);
    --button-focus-visible-shadow-size: calc(var(--size-sm) * 0.5);
  }

  .${unsafeCSS(Sizes.LG)} {
    --button-font-size: var(--size-lg);
    --button-padding: var(--size-lg);
    --button-focus-visible-shadow-size: calc(var(--size-lg) * 0.5);
  }

  .${unsafeCSS(Sizes.XL)} {
    --button-font-size: var(--size-xl);
    --button-padding: var(--size-xl);
    --button-focus-visible-shadow-size: calc(var(--size-xl) * 0.5);
  }

  .${unsafeCSS(Sizes.XXL)} {
    --button-font-size: var(--size-xxl);
    --button-padding: var(--size-xxl);
    --button-focus-visible-shadow-size: calc(var(--size-xxl) * 0.5);
  }
`;
